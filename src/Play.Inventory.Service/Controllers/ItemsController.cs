...
namespace Play.Inventory.Service.Controllers
{
    ...
    public class ItemsController : ControllerBase
    {
        ...
        public async Task<ActionResult<IEnumerable<InventoryItem>>> GetAsync(Guid userId)
        {
			...
			var items = inventoryItemEntities.Select(item => item.CatalogItemId);
			var catalogItemEntities = await catalogItemsRepository.GetAllAsync(item => items.Contains(item.Id));
